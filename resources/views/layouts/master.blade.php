...
<!-- Buttons examples -->
        ...
        <script src="{{ asset('templatecontenu/assets/libs/datatables.net-keytable/js/dataTables.keyTable.min.js') }}"></script>
        <script src="{{ asset('templatecontenu/assets/libs/datatables.net-select/js/dataTables.select.min.js') }}"></script>
        
 <!-- Responsive examples -->
        <script src="{{ asset('templatecontenu/assets/libs/datatables.net-responsive/js/dataTables.responsive.min.js') }}"></script>
