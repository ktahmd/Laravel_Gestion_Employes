          ...
          <div class="collapse navbar-collapse float-end" id="navbarCollapse">
            <ul class="navbar-nav mb-2 mb-md-0">
              @if (Route::has('login'))
                  @auth
                  <li class="nav-item">
                      <a class="nav-link" href="{{ url('/dashboard') }}"   wire:navigate>Dashboard</a>
                  </li>
                      @else
                  <li class="nav-item">
    ...
    <main>
      ...
      <div class="container marketing">
        ...
        <div class="row featurette">
            ...
            <br><br>
          <div class="col-md-7">
            <h2 class="featurette-heading fw-normal lh-1">Welcome page <span class="text-body-secondary"></span></h2>
            <p class="lead">Some great placeholder content for the first featurette here. Imagine some exciting prose here.Some great placeholder content for the first featurette here. Imagine some exciting prose hereSome great placeholder content for the first featurette here. Imagine some exciting prose hereSome great placeholder content for the first featurette here. Imagine some exciting prose hereSome great placeholder content for the first featurette here. Imagine some exciting prose hereSome great placeholder content for the first featurette here. Imagine some exciting prose hereSome great placeholder content for the first featurette here. Imagine some exciting prose hereSome great placeholder content for the first featurette here. Imagine some exciting prose hereSome great placeholder content for the first featurette here. Imagine some exciting prose here</p>
          </div>
          <div class="col-md-5">
           
<img width="500" align=center src="{{asset('logo/app-logo.jpg')}}">
      ...
      <footer class="container">
        {{-- <p class="nav-item nav-link float-end"><a href="#">Back to top</a></p> --}}
        <p>&copy; 2024 KLK Group,  </p>
      </footer>
    </main>
